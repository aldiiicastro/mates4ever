...
import {View, Image, Text, ScrollView, Button, Pressable, StyleSheet, Dimensions} from 'react-native'
        ...
        <ScrollView vertical style={{backgroundColor: "#fff", width: "100%"}}>
            ...
            <View>
                <View>
                    ...
                    {/*        <Pressable style={[styles.button, styles.buttonClose]} testID={'hideModal'} onPress={() => createComment()}>*/}
