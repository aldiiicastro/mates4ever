...
export default function PetsStatesView(props) {
    ...
    return (<View>
            <PetsHorizontalView navigation={props.navigation} title={"Animales perdidos"} pets={lostPets}/>
            <PetsHorizontalView navigation={props.navigation}title={"Animales en adopción"} pets={adoptionPets}/>
            <PetsHorizontalView navigation={props.navigation} title={"Animales en transito"} pets={transitPets}/>
        </View>)
}
