...
class PetDataLoader: CommandLineRunner {
    ...
    fun loadPetData() {
        ...
        val user = User(null, "Mates4Ever", "Org", "mates4ever@gmail.com", "Ejemplo12", 1112345678, "Bernal", "Buenos Aires", "", listOf())
        val pets = listOf(
            Pet("Mía", "https://github.com/aldiiicastro/mates4ever/blob/main/frontend/assets/gatitos/Mia.jpg?raw=true",
                null,"Gato", null, "Transito", user, true,true, null,"Tenemos muchos animales y necesitamos que alguien pueda transitarlo o adoptarlo"),
            ...
            Pet("Venom", "https://github.com/aldiiicastro/mates4ever/blob/main/frontend/assets/gatitos/Venom.jpg?raw=true",
                null,"Gato", null, "Adopción", user,  true, true, null, "Mi gatita los tuvo hace poco y buscamos a alguien que les den un buen hogar"),
            ...
            Pet("Batman", "https://github.com/aldiiicastro/mates4ever/blob/main/frontend/assets/gatitos/Batman.jpg?raw=true",
                null,"Gato", null, "Perdido", user, true, true, null, "Lo encontre en la puerta de mi casa"),
            ...
            Pet("Nella", "https://github.com/aldiiicastro/mates4ever/blob/main/frontend/assets/conejitos/Nella.jpg?raw=true",
                null,"Conejo", null, "Transito", user, true, true, null, "Tenemos muchos animales y necesitamos que alguien pueda transitarlo o adoptarlo"),
            ...
            Pet("Curry", "https://github.com/aldiiicastro/mates4ever/blob/main/frontend/assets/conejitos/Curry.jpg?raw=true",
                null,"Conejo", null, "Adopción", user, true, true, null, "Mi conejo los tuvo hace poco y buscamos a alguien que les den un buen hogar"),
            ...
            Pet("Jar jar", "https://github.com/aldiiicastro/mates4ever/blob/main/frontend/assets/conejitos/Jar.jpg?raw=true",
                null,"Conejo", null, "Perdido", user, true, true, null, "Lo encontre en la puerta de mi casa"),
            Pet("Odie", "https://github.com/aldiiicastro/mates4ever/blob/main/frontend/assets/perritos/Odie.jpg?raw=true",
                null,"Perro", null, "Adopción", user, true, true, null, "Mi perrita los tuvo hace poco y buscamos a alguien que les den un buen hogar"),
            ...
            Pet("Milo", "https://github.com/aldiiicastro/mates4ever/blob/main/frontend/assets/perritos/Milo.jpg?raw=true",
                null,"Perro", null, "Transito", user, true, true, null, "Tenemos muchos animales y necesitamos que alguien pueda transitarlo o adoptarlo"),
            ...
            Pet("Kira", "https://github.com/aldiiicastro/mates4ever/blob/main/frontend/assets/perritos/Kira.jpg?raw=true",
                null,"Perro", null, "Perdido", user, true, true, null, "Lo encontre en la puerta de mi casa"),
